...
(function (M) {
   ...
   M.config('predefinedWMC', {
       ...
       * @api stable
       */
      'urls': [window.location.origin + '/lib/mapea/files/wmc/romero2017_mapa.xml',window.location.origin + '/lib/mapea/files/wmc/romero2017_satelite.xml'],
