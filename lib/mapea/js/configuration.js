...
(function (M) {
   ...
   M.config('predefinedWMC', {
       ...
       * @api stable
       */
      'urls': 'lib/mapea/files/wmc/context_romero2016.xml,lib/mapea/files/wmc/context_romero2016_iOS.xml'.split(','),
       ...
       * @api stable
       */
      'predefinedNames': 'romero,romero_ios'.split(','),
       ...
       * @api stable
       */
      'names': 'Plan Romero,Plan Romero'.split(',')
   });
